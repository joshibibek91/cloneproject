...
const cardsData = [
  ...
  { id: 4, firstname: "Aaviskar", lastname: "Poudyal", title: 'Project Manager, S&S', backgroundImage: `linear-gradient(180deg, rgba(249, 80, 0, 0) 35%, rgba(14, 14, 14, 0.89) 78%), url(${backgroundImage})`, facebooklink: 'www.facebook.com', instalink: 'https://www.instagram.com/', mailme: 'https://www.gmail.com/' },
  { id: 5, firstname: "Kritan", lastname: "Pandey", title: 'Project Manager, S&S', backgroundImage: `linear-gradient(180deg, rgba(249, 80, 0, 0) 35%, rgba(14, 14, 14, 0.89) 78%), url(${backgroundImage})`, facebooklink: 'www.facebook.com', instalink: 'https://www.instagram.com/', mailme: 'https://www.gmail.com/' },
  { id: 6, firstname: "Skanda", lastname: "Aryal", title: 'Project Manager, S&S', backgroundImage: `linear-gradient(180deg, rgba(249, 80, 0, 0) 35%, rgba(14, 14, 14, 0.89) 78%), url(${backgroundImage})`, facebooklink: 'www.facebook.com', instalink: 'https://www.instagram.com/', mailme: 'https://www.gmail.com/' },
  { id: 7, firstname: "Yalamber", lastname: "Rai", title: 'Project Manager, S&S', backgroundImage: `linear-gradient(180deg, rgba(249, 80, 0, 0) 35%, rgba(14, 14, 14, 0.89) 78%), url(${backgroundImage})`, facebooklink: 'www.facebook.com', instalink: 'https://www.instagram.com/', mailme: 'https://www.gmail.com/' },
];
      ...
      <Slider {...settings}>
        {cardsData.map((data) => (
          ...
          <div className="card1" key={data.id} >
            <div style={{ backgroundImage: `${data.backgroundImage}` }} className='card1'>
